...
export default async function Page(props: {
  ...
  if (!searchParams.no_embed) {
    ...
    const response = await fetch(
      `${process.env.NEXT_PUBLIC_BASE_URL}/api/embedded-checkout?session_id=${searchParams.session_id}`
    );
    ...
    return (
      <section>
        <p>
          ...
          {session.customer_email}. The order will be processed and shipped to
          you within 24 hours. If you have any questions, please email{" "}
