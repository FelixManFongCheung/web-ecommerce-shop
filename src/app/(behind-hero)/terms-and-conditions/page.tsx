    ...
    <div className="flex flex-col md:flex-row gap-10 md:gap-20">
      <div className="flex-1">
        ...
        <div className="grid grid-cols-2 gap-4 mb-4">
          <p className="italic">Denmark</p>
          <p>typically within 1-2 business days after dispatch.</p>
          <p className="italic">International</p>
          <p>typically within 3-7 business days after dispatch.</p>
        </div>
        {/* TODO: bold needs to be added for the font of this text */}
        <p className="mb-4">
          <span className="font-extrabold !font-[Athelas_Bold_Italic]">
            Please note
          </span>{" "}
          <span className="italic">– Proxy Archive is not responsible for any taxes or duties applied to
